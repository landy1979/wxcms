<?php
/* Smarty version 3.1.29, created on 2017-07-18 16:11:07
  from "E:\web\lmfyjk\web\admin\tpl\doctor\add.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_596dc29b7bfd91_62179275',
  'file_dependency' => 
  array (
    'b3b30101026a4aee77cebf51cf7463b0596a459a' => 
    array (
      0 => 'E:\\web\\lmfyjk\\web\\admin\\tpl\\doctor\\add.tpl',
      1 => 1500365463,
      2 => 'file',
    ),
  ),
...
function content_596dc29b7bfd91_62179275 ($_smarty_tpl) {
?>
...
<div class="container">
    ...
    <?php if ($_smarty_tpl->tpl_vars['depid']->value == 0) {?>
    <tr>
    	<td class="label">所在科室：</td>
      <td>
      	<select name="depart" id="depart" class="form-input">
        	<?php
$_from = $_smarty_tpl->tpl_vars['depart']->value;
...
"><?php echo $_smarty_tpl->tpl_vars['value']->value['depname'];?>
</option>
          <?php
    ...
    <tr>
      ...
      <td>
      	<select name="title" id="title" class="form-input">
      		<?php
$_from = $_smarty_tpl->tpl_vars['titles']->value;
if (!is_array($_from) && !is_object($_from)) {
settype($_from, 'array');
}
