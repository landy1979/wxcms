...
<div class="container">
	<table border="0" cellpadding="0" cellspacing="0" width="100%" align="center" class="commTab">
	    ...
	    <td><input type="text" name="titlename" id="titlename" size="30" class="form-input" value="{{$res.titname}}"><span class="required">*</span></td>
    </tr>
    <tr>
    	<td class="label">预约费用：</td>
      <td><input type="text" name="cost" id="cost" size="30" class="form-input" value="{{$res.cost}}" /> 元 (四舍五入后保留2位小数)<span class="required">*</span></td>
		</tr>
    <tr>
