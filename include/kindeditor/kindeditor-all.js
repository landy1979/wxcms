...
// Baidu Maps: http://dev.baidu.com/wiki/map/art.list.php?title=%E9%A6%96%E9%A1%B5
		...
		var dialog = self.createDialog({
			...
			yesBtn : {
				...
				click : function(e) {
					...
					var url = [checkbox[0].checked ? self.pluginsPath + 'baidumap/art.list.php' : 'http://api.map.baidu.com/staticimage',
...
// Google Maps: http://code.google.com/apis/maps/art.list.php
